...
public class CitizenLocalServiceImpl extends CitizenLocalServiceBaseImpl {
	...
	public Citizen addCitizen(String fullName, String personalId, int gender,
		...
		User mappingUser = userService.addUserWithWorkflow(
				...
				spn.getMidName(), spn.getLastName(), 0, 0, (gender == 1),
				birthDateMonth, birthDateDay, birthDateYear, "Citizen",
	...
	public void deleteCitizenByCitizenId(long citizenId)
		...
		long mappingUserId = citizen.getMappingUserId();
		...
		citizenPersistence.remove(citizenId);
	...
	public Citizen updateCitizen(long citizenId, String fullName,
		...
		if (mappingUser != null) {
			...
			// Change user name
			if (!fullName.equals(citizen.getFullName())) {
